...
export const buildStrReplaceTool = (fileSystem: VirtualFileSystem) => {
  return tool({
    description:
      "A text editor tool for creating, viewing, and editing files. Use 'create' to make new files, 'view' to read files, 'str_replace' to edit files, and 'insert' to add lines.",
